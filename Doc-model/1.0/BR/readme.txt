Merci de verifier les points suivants lors de la generation du BR :
...
** avant la generation : 
 ...
 3- copier le fichier excel dans ce dossier BR ci-dessus
 4- supprimer le fichier input_data existant et renommer l'excel en "input_data"
 5- génerer en cliquant sur le fichier : "generate_BR_2024_demat-v2.0.xlsx"
 6- cliquer sur le bouton "activer le contenu" en haut s'il apparait. et verifier si les montnants commencent a changer
